...
init()
{
	...
	precacheTurret( "cobra_player_minigun_mp" );
...
spawnAttackLittleBird( owner, pathStart, pathGoal, coord )
{
	...
	mgTurret1 = spawnTurret( "misc_turret", lb.origin, "cobra_player_minigun_mp" );
	...
	mgTurret2 = spawnTurret( "misc_turret", lb.origin, "cobra_player_minigun_mp" );
